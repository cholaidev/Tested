...
<Grid
                ...
                >
                    <Button variant="contained" style={{ backgroundColor: "#4ca832", left: 20, top: 45, fontSize: "14px" }} onClick={handleSubmit}>Submit</Button>
                    <Button style={{ backgroundColor: "#781055", left: 100, top: 45, fontSize: "14px" }}
